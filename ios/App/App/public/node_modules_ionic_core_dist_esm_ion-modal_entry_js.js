...
/* harmony import */ var _cubic_bezier_c313947a_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cubic-bezier-c313947a.js */ 1077);
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 2172);
...
/* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./gesture-controller-17e82006.js */ 607);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,C_Users_49178_Desktop_SocialMediaSytems_Integrationsprojekt_2_juntos_events_ip2_Juntos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
 ...
 * the block is at position carousel = 1.
 * Pressing on the block moves it to position carousel = 0;
 ...
 * a = -k(carousel - 1) - cv
 *
 * We can represent the motion of something as a function of time: f(t) = carousel.
 ...
 *
 * We know that at t = 0, we are at carousel = 0 because the modal does not move: f(0) = 0
 ...
 * at a particular carousel coordinate. This
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);
  ...
  if (presentingEl) {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().afterStyles({
          transform: finalTransform
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  return (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  return (0,_animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  connectedCallback() {
    (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.e)(this.el);
  }
  ...
  checkCanDismiss() {
    ...
    return (0,C_Users_49178_Desktop_SocialMediaSytems_Integrationsprojekt_2_juntos_events_ip2_Juntos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        canDismiss
      } = _this;
      /**
  ...
  present() {
    ...
    return (0,C_Users_49178_Desktop_SocialMediaSytems_Integrationsprojekt_2_juntos_events_ip2_Juntos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_ce4f806c_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this2.el, _this2.component, ['ion-page'], data, inline);
      yield (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
      (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this2.el.classList.add('show-modal'));
      _this2.currentTransition = (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.d)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_Users_49178_Desktop_SocialMediaSytems_Integrationsprojekt_2_juntos_events_ip2_Juntos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_49178_Desktop_SocialMediaSytems_Integrationsprojekt_2_juntos_events_ip2_Juntos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const enteringAnimation = _overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.h.get(_this5) || [];
      _this5.currentTransition = (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_ce4f806c_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
  ...
  onDidDismiss() {
    return (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionModalDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionModalWillDismiss');
  }
  /**
