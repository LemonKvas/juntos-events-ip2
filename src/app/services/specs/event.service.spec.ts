...
describe('EventService', () => {
  ...
  const event: Event[] = [
    new Event(
      'Kanufahren',
      ['fF8qQSTRoktB2e8vWiJr'],
      new Date(),
      new Date(),
      '30',
      'Kanufahren für Abenteuerlustige! Wer Interesse hat, kann sich ab sofort anmelden. Bei Frage einfach schreiben',
      ['Sport', 'Outdoor'],
      ['gD0SEr33LwVAkIQWZJdC2Aj67TA2', 'fdZbWH9uybaWwJuNJrOp7t0TwWU2'],
      10,
      { street: 'Am See', house: 43, zipCode: 64729, city: 'Hamburg' },
      true,
      'gWpRSCzH4F2etkUS4tCy',
      'fdZbWH9uybaWwJuNJrOp7t0TwWU2'
    ),
    new Event(
      'Party im Garten',
      ['fF8qQSTRoktB2e8vWiJr'],
      ...
      new Date(),
      '0',
      'Party mit Musik, Getränke und Essen.',
      ['Party', 'Musik'],
      ['8z6t59u43qt43', 'nh834wWU2'],
      50,
      { street: 'Danziger Straße', house: 1, zipCode: 36482, city: 'München' },
      false,
      'u4923hhw39b',
      'fe56tbaWw57JuNJrO'
    )
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [EventService, { provide: AngularFirestore, userValue: angularFirestoreStub }]
    });
